    ...
    >
      ...
      <div className="container my-5 py-4">
        <div className="row featurette align-items-center">
          {/* Text Content */}
          <div className="col-lg-7 col-md-12 order-1 d-flex flex-column justify-content-center align-items-center text-center text-lg-start">
          ...
          {/* Image */}
          <div className="col-lg-5 col-md-12 order-md-1 order-2 text-center">
            <img
        ...
        <div className="container">
          ...
          <div className="row justify-content-center text-center mb-5">
            <div className="col-md-8">
              <h2 className="hd aos-init aos-animate text-black" data-aos="fade-up">
      ...
      >
        <div className="p-5 text-center">
          <div className="container py-5">
            <h1 className=" heading">International Tour Management.</h1>
        ...
        <div className="row py-lg-5">
          <div className="col-lg-6 col-md-8 mx-auto text-center">
            <h1 className="fw-light">Recent Blog Post</h1>
      ...
      <div className="section bg-light py-5">
        <div className="container">
          ...
          <div className="row justify-content-center text-center mb-5">
            <div className="col-md-8">
              <h2 className="hd text-black aos-init aos-animate " data-aos="fade-up">
                Happy Customers
              </h2>
              ...
              <div className="d-block">
                <div className="align-items-center m-2 p-2">
                  ...
                  <div className="m-2 text-center">
                    ...
                    <div className="d-flex justify-content-between  align-items-center" style={{ color: '#ffa500', justifyContent: 'flex-end' }}>
                      <spann><i className="fa fa-star"></i>
                        <i className="fa fa-star"></i>
                        <i className="fa fa-star"></i>
                        <i className="fa fa-star-half-alt"></i>
                        <i className="fa-regular fa-star"></i></spann>
            ...
            <div className="col-12 col-md-6 col-lg-4 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
              <div className="d-block">
                <div className="align-items-center m-2 p-2">
                  ...
                  <div className="m-2 text-center">
                    <h3 style={{ color: '#333' }}>Airplane</h3>
                    <div className="d-flex justify-content-between align-items-center" style={{ color: '#ffa500' }}>
                      <spand>  <i className="fa fa-star"></i>
                        <i className="fa fa-star"></i>
                        <i className="fa fa-star"></i>
                        <i className="fa fa-star-half-alt"></i>
                        <i className="fa-regular fa-star"></i></spand>
                      <span style={{ color: '#666', marginLeft: '10px' }}>(123 Reviews)</span>
                    </div>
                  </div>
                </div>
